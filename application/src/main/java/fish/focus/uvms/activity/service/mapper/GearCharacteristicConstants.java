...
public final class GearCharacteristicConstants {
    ...
    public static final String GEAR_CHARAC_TYPE_CODE_HE = "HE";
    public static final String GEAR_CHARAC_TYPE_CODE_NI = "NI";
    public static final String GEAR_CHARAC_TYPE_CODE_NN = "NN";
